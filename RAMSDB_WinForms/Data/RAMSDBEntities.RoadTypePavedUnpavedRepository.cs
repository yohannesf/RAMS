...
{
    public partial class RoadTypePavedUnpavedRepository : EntityFrameworkRepository<RAMSDBModel.RoadTypePavedUnpaved>, IRoadTypePavedUnpavedRepository
    {
        public RoadTypePavedUnpavedRepository(RAMSDBModel.RAMSDBEntities context) : base(context)
        {
        }

        public virtual ICollection<RAMSDBModel.RoadTypePavedUnpaved> GetAll()
        {
            return objectSet.ToList();
        }

        public virtual RAMSDBModel.RoadTypePavedUnpaved GetByKey(int _ID)
        {
