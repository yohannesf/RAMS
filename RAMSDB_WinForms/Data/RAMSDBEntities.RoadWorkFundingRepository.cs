...
{
    public partial class RoadWorkFundingRepository : EntityFrameworkRepository<RAMSDBModel.RoadWorkFunding>, IRoadWorkFundingRepository
    {
        public RoadWorkFundingRepository(RAMSDBModel.RAMSDBEntities context) : base(context)
        {
        }

        public virtual ICollection<RAMSDBModel.RoadWorkFunding> GetAll()
        {
            return objectSet.ToList();
        }

        public virtual RAMSDBModel.RoadWorkFunding GetByKey(int _ID)
        {
