...
namespace RAMSDBModel
{
    ...
    public partial class PavedOverallCondition : INotifyPropertyChanged
    {
        ...
        public virtual int PavedConditionRate
        {
            get
            {
                return _PavedConditionRate;
            }
            set
            {
                if (_PavedConditionRate != value)
                {
                    _PavedConditionRate = value;
                    OnPropertyChanged("PavedConditionRate");
                }
            }
        }
        private int _PavedConditionRate;
        ...
        public virtual ObservableListSource<PavedRoadConditionSurvey> PavedRoadConditionSurveys_CarriagewayOverallCondition { get; set; }
        [System.ComponentModel.DataAnnotations.Schema.InverseProperty("PavedOverallCondition_LeftDrainOverallCondition")]
        public virtual ObservableListSource<PavedRoadConditionSurvey> PavedRoadConditionSurveys_LeftDrainOverallCondition { get; set; }
        [System.ComponentModel.DataAnnotations.Schema.InverseProperty("PavedOverallCondition_RightDrainOverallCondition")]
        public virtual ObservableListSource<PavedRoadConditionSurvey> PavedRoadConditionSurveys_RightDrainOverallCondition { get; set; }
