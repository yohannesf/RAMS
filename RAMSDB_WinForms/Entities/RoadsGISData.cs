...
namespace RAMSDBModel
{
    ...
    public partial class RoadsGISData : INotifyPropertyChanged
    {
        ...
        [System.ComponentModel.DataAnnotations.Schema.Column(TypeName = "decimal", Order = 21)]
        public virtual decimal? PopulationServed
        {
            get
            {
                return _PopulationServed;
            }
            set
            {
                if (_PopulationServed != value)
                {
                    _PopulationServed = value;
                    OnPropertyChanged("PopulationServed");
                }
            }
        }
        private decimal? _PopulationServed;
