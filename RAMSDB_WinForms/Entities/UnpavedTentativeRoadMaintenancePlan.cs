...
{
    [System.ComponentModel.DataAnnotations.Schema.Table("UnpavedTentativeRoadMaintenancePlan", Schema = "dbo")]
    public partial class UnpavedTentativeRoadMaintenancePlan : INotifyPropertyChanged
    {

        public UnpavedTentativeRoadMaintenancePlan()
        {
            OnCreated();
        }
        ...
        [System.ComponentModel.DataAnnotations.Schema.InverseProperty("UnpavedTentativeRoadMaintenancePlans")]
        public virtual UnpavedCategoryofWork UnpavedCategoryofWork
        {
            get
            {
                return _UnpavedCategoryofWork;
            }
            set
            {
                if (_UnpavedCategoryofWork != value)
                {
                    _UnpavedCategoryofWork = value;
                    OnPropertyChanged("UnpavedCategoryofWork");
                }
            }
        }
        private UnpavedCategoryofWork _UnpavedCategoryofWork;
