...
namespace RAMSDBModel
{
    ...
    public partial class CriteriaWeight : INotifyPropertyChanged
    {
        ...
        public virtual ObservableListSource<CooperativeCentersAlongRoad> CooperativeCentersAlongRoads { get; set; }
        [System.ComponentModel.DataAnnotations.Schema.InverseProperty("CriteriaWeight")]
        public virtual ObservableListSource<EducationCentersAlongRoad> EducationCentersAlongRoads { get; set; }
        [System.ComponentModel.DataAnnotations.Schema.InverseProperty("CriteriaWeight")]
        public virtual ObservableListSource<HealthCentersAlongRoad> HealthCentersAlongRoads { get; set; }
        [System.ComponentModel.DataAnnotations.Schema.InverseProperty("CriteriaWeight")]
        public virtual ObservableListSource<KebelesVillagesCommunitiesConnected> KebelesVillagesCommunitiesConnecteds { get; set; }
        [System.ComponentModel.DataAnnotations.Schema.InverseProperty("CriteriaWeight")]
        public virtual ObservableListSource<MarketsConnectByRoad> MarketsConnectByRoads { get; set; }
        [System.ComponentModel.DataAnnotations.Schema.InverseProperty("CriteriaWeight")]
        public virtual ObservableListSource<OtherProjectsAlongRoad> OtherProjectsAlongRoads { get; set; }
        [System.ComponentModel.DataAnnotations.Schema.InverseProperty("CriteriaWeight")]
        public virtual ObservableListSource<RoadClassification> RoadClassifications { get; set; }
        [System.ComponentModel.DataAnnotations.Schema.InverseProperty("CriteriaWeight")]
        public virtual ObservableListSource<RoadTraversesFarmland> RoadTraversesFarmlands { get; set; }
        [System.ComponentModel.DataAnnotations.Schema.InverseProperty("CriteriaWeight")]
        public virtual ObservableListSource<TradingCentersAlongRoad> TradingCentersAlongRoads { get; set; }
        [System.ComponentModel.DataAnnotations.Schema.InverseProperty("CriteriaWeight")]
        public virtual ObservableListSource<TrafficPerDayPoints> TrafficPerDayPoints { get; set; }
