...
{
    public partial interface IRoadWorkFundingRepository : IRepository<RAMSDBModel.RoadWorkFunding>
    {
        ICollection<RAMSDBModel.RoadWorkFunding> GetAll();
        RAMSDBModel.RoadWorkFunding GetByKey(int _ID);
    }
}
