...
{
    public partial interface IStructuresInventoryRepository : IRepository<RAMSDBModel.StructuresInventory>
    {
        ICollection<RAMSDBModel.StructuresInventory> GetAll();
        RAMSDBModel.StructuresInventory GetByKey(int _StructureID);
    }
}
