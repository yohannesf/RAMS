...
{
    public partial interface IRoadsCrossingWoredasRepository : IRepository<RAMSDBModel.RoadsCrossingWoredas>
    {
        ICollection<RAMSDBModel.RoadsCrossingWoredas> GetAll();
        RAMSDBModel.RoadsCrossingWoredas GetByKey(int _ID);
    }
}
