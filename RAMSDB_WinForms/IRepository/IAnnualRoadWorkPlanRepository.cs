...
{
    public partial interface IAnnualRoadWorkPlanRepository : IRepository<RAMSDBModel.AnnualRoadWorkPlan>
    {
        ICollection<RAMSDBModel.AnnualRoadWorkPlan> GetAll();
        RAMSDBModel.AnnualRoadWorkPlan GetByKey(int _AnnualPlanID);
    }
}
