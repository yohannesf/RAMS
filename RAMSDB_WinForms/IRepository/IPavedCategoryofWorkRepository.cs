...
{
    public partial interface IPavedCategoryofWorkRepository : IRepository<RAMSDBModel.PavedCategoryofWork>
    {
        ICollection<RAMSDBModel.PavedCategoryofWork> GetAll();
        RAMSDBModel.PavedCategoryofWork GetByKey(int _CatWorkID);
    }
}
