...
{
    public partial interface IRoadTypePavedUnpavedRepository : IRepository<RAMSDBModel.RoadTypePavedUnpaved>
    {
        ICollection<RAMSDBModel.RoadTypePavedUnpaved> GetAll();
        RAMSDBModel.RoadTypePavedUnpaved GetByKey(int _ID);
    }
}
