...
{
    public partial interface IPavedShoulderEdgeStepRepository : IRepository<RAMSDBModel.PavedShoulderEdgeStep>
    {
        ICollection<RAMSDBModel.PavedShoulderEdgeStep> GetAll();
        RAMSDBModel.PavedShoulderEdgeStep GetByKey(int _ID);
    }
}
