...
{
    public partial class AnnualExpenditurePlan : DevExpress.XtraEditors.XtraUserControl// DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        public AnnualExpenditurePlan(int roadID)
        {
            InitializeComponent();
        ...
        private void GridView_ValidateRow(object sender, DevExpress.XtraGrid.Views.Base.ValidateRowEventArgs e)
        {
            ...
            if ((Guid)view.GetRowCellValue(e.RowHandle, view.Columns["RoadID"]) == null)
            {
