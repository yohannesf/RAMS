...
{
    public partial class RoadWorkProgress : DevExpress.XtraEditors.XtraUserControl// DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        public RoadWorkProgress(int roadID)
        {
            InitializeComponent();
