...
{
    public partial class AnnualWorkPlan : DevExpress.XtraEditors.XtraUserControl// DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        public AnnualWorkPlan()
        {
            ...
            annualRoadWorkPlanBindingSource.DataSource = _context.AnnualRoadWorkPlan.
            ...
            bsiRecordsCount.Caption = "RECORDS : " + _context.AnnualRoadWorkPlan.
                Where(p => roadsAssignedForUser.Contains(p.RoadID) && p.FYearEC == yearFilter).ToList().Count;
        }

        public AnnualWorkPlan(int roadID)
        {
            InitializeComponent();
        ...
        private void GridView_ValidateRow(object sender, DevExpress.XtraGrid.Views.Base.ValidateRowEventArgs e)
        {
            ...
            if ((int)view.GetRowCellValue(e.RowHandle, view.Columns["RoadID"]) == 0)
            {
                view.SetColumnError(null, "Required");
                e.Valid = false;
                e.ErrorText = "Road Information is Required";
            }
            ...
            if (e.Valid)
            {
                ...
                {
                    RAMSDBModel.AnnualRoadWorkPlan dw = (RAMSDBModel.AnnualRoadWorkPlan)view.GetRow(e.RowHandle);


                    //  dataLoader.AddNew(dw, "UnpavedRoadConditionSurvey");


                    _context.AnnualRoadWorkPlan.Add(dw);
        ...
        private void bbiDelete_ItemClick(object sender, ItemClickEventArgs e)
        {
            if (gridView1.SelectedRowsCount > 0)
            {
                ...
                if (!view.IsGroupRow(rowHandle))
                {
                    ...
                    {
                        RAMSDBModel.AnnualRoadWorkPlan dw = (RAMSDBModel.AnnualRoadWorkPlan)view.GetRow(rowHandle);

                        //dataLoader.Delete(dw, "UnpavedRoadConditionSurvey");
                        //dataLoader.SaveData();
                        ////   _context.MultiCriteriaAnalysisData.Attach(dw);
                        _context.AnnualRoadWorkPlan.Remove(dw);
                        _context.SaveChanges();
