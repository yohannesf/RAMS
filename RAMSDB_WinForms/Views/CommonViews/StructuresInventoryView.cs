...
{
    public partial class StructuresInventoryView : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        public StructuresInventoryView()
        {
            InitializeComponent();
        ...
        public StructuresInventoryView(Guid roadID)
        {
            InitializeComponent();
            ...
            structuresInventoryBindingSource.DataSource = _context.StructuresInventory.Where(r => r.RoadID == _roadID).ToList();
            bsiRecordsCount.Caption = "RECORDS : " + _context.StructuresInventory.Where(r => r.RoadID == _roadID).ToList().Count;
        ...
        private void GridView_ValidateRow(object sender, DevExpress.XtraGrid.Views.Base.ValidateRowEventArgs e)
        {
            ...
            if (e.Valid)
            {
                ...
                {
                    RAMSDBModel.StructuresInventory dw = (RAMSDBModel.StructuresInventory)view.GetRow(e.RowHandle);

                    _context.StructuresInventory.Add(dw);
        ...
        private void bbiDelete_ItemClick(object sender, ItemClickEventArgs e)
        {
            if (gridView1.SelectedRowsCount > 0)
            {
                ...
                if (!view.IsGroupRow(rowHandle))
                {
                    ...
                    {
                        RAMSDBModel.StructuresInventory dw = (RAMSDBModel.StructuresInventory)view.GetRow(rowHandle);


                        _context.StructuresInventory.Remove(dw);
                        _context.SaveChanges();
