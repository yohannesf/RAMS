...
{
    public partial class PavedMainNavigation : DevExpress.XtraEditors.XtraUserControl //DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        void accordionControl_SelectedElementChanged(object sender, SelectedElementChangedEventArgs e)
        {
            ...
            try
            {
                ...
                switch (elementName)
                {
                    ...
                    case "accItemRoadsAssigned":
                        userControl = new RAMSDB_WinForms.RoadsAssignedWidget("Paved");
                    ...
                    case "accItemMaintenanceCost":
                        ...
                        userControl.Text = "Paved Roads Maintenance Cost per Road";
                        break;

                    case "accItemPopServed":
                        userControl = new PopServed("Paved");
                        userControl.Text = "Population Served Per Paved Road";
                        break;
        ...
        private void PavedMainNavigation_Load(object sender, EventArgs e)
        {
        ...
        private void PavedMainNavigation_FormClosing(object sender, FormClosingEventArgs e)
        {

        }

        private void PavedMainNavigation_FormClosed(object sender, FormClosedEventArgs e)
        {
