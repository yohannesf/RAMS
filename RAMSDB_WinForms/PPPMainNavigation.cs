...
{
    public partial class PPPMainNavigation : DevExpress.XtraEditors.XtraUserControl // DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        void accordionControl_SelectedElementChanged(object sender, SelectedElementChangedEventArgs e)
        {
            ...
            try
            {
                ...
                switch (e.Element.Name)
                {
                    ...
                    case "accItemAnnualWorkPlanPVT":
                        userControl = new RAMSDB_WinForms.frmUnpavedAnnualPlanReport();
                        //    ribbonControl.SelectPage(ribb);
                        //       userControl.Select();
                        userControl.Text = "Annual Road Work Plan - Tentative";
                        break;
                    //.Name = accItemAnnualWorkPlanPVT
                    case "accItemAllocationofFunds":

                        userControl = new RAMSDB_WinForms.PPP.AllocationOfFundsView();

                        userControl.Text = "Allocation of Funds";

                        break;

                    case "accItemAnnualExpenditurePlan":

                        userControl = new RAMSDB_WinForms.PPP.AnnualExpenditurePlan();

                        userControl.Text = "Annual Expenditure Plan";

                        break;

                    case "accItemAnnualWorkPlan":

                        userControl = new RAMSDB_WinForms.PPP.AnnualWorkPlan();

                        userControl.Text = "Annual Road Word Plan";

                        break;

                    case "accItemContractPMSView":

                        userControl = new RAMSDB_WinForms.PPP.ContractPeriodiMSpotRRehabView();

                        userControl.Text = "Contract Register for Periodic/Rehabilitation work";

                        break;

                    case "accItemContractRMView":

                        userControl = new RAMSDB_WinForms.PPP.ContractRoutineMaintenanceView();

                        userControl.Text = "Contract Register for Routine Maintenance Work";

                        break;

                    case "accItemExpProgress":

                        userControl = new RAMSDB_WinForms.PPP.RoadExpenditureProgress();

                        userControl.Text = "Expenditure Performance Register";

                        break;

                    case "accItemOfficeAdminCost":

                        userControl = new RAMSDB_WinForms.PPP.OfficeAdminCostView();

                        userControl.Text = "Annual Cost Plan for Office and Administration";

                        break;

                    case "accItemRoadWorkProgress":
                        userControl = new RAMSDB_WinForms.PPP.RoadWorkProgress();

                        userControl.Text = "Road Work Performance Register";
                        ...
                        ////    userControl = new PavedRoadConditionSurveyFilters();// UnpavedSurveyView;
        ...
        private void PPPMainNavigation_Load(object sender, EventArgs e)
        {
            accordionControl.SelectedElement = accItemAnnualWorkPlanPVT;// accItemRoadsAssigned;
        ...
        private void PPPMainNavigation_FormClosing(object sender, FormClosingEventArgs e)
        {

        }

        private void PPPMainNavigation_FormClosed(object sender, FormClosedEventArgs e)
        {
