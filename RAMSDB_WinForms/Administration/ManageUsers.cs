...
{
    public partial class ManageUsers : DevExpress.XtraEditors.XtraUserControl // DevExpress.XtraBars.Ribbon.RibbonForm
    {
     ...
     //   public int _roadID;
       // public int _year = DateTime.Now.Year;
        ...
        public ManageUsers()
        {
          ...
          //  userRolesBindingSource.DataSource = _context.UserRole.ToList();
            roleBindingSource.DataSource = _context.Role.ToList();
            lblRegion.Text = _region;

             adminBoundaryBindingSource.DataSource = adminBoundary;

            userBindingSource.DataSource = _users;// usersWithRoles;

            //BindingList<Customer> dataSource = GetDataSource();
            //gridControl1.DataSource = dataSource;
            bsiRecordsCount.Caption = "RECORDS : " + _users.Count;// usersWithRoles.Count;
        }

        public ManageUsers(int roadID)
        {
            //InitializeComponent();
        ...
        private void GridView_InitNewRow(object sender, DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs e)
        {
            ...
            view.SetRowCellValue(e.RowHandle, colUserID, uID);// _region);
            view.SetRowCellValue(e.RowHandle, colRegion, _region);
           view.SetRowCellValue(e.RowHandle, colIsActive, true);
            view.SetRowCellValue(e.RowHandle, colPassword, 123);
            view.SetRowCellValue(e.RowHandle,colCreatedDate,DateTime.Now);
            view.SetRowCellValue(e.RowHandle,colModifiedDate, DateTime.Now);
        ...
        private void GridView_ValidateRow(object sender, DevExpress.XtraGrid.Views.Base.ValidateRowEventArgs e)
        {
            ...
            if (view.GetRowCellValue(e.RowHandle, colUserName) == null)
            {
                view.SetColumnError(null, "Required");
                e.Valid = false;
                e.ErrorText = "User Name is Required";
            }


            if (view.GetRowCellValue(e.RowHandle, colRoleID) == null)
            {
                view.SetColumnError(null, "Required");
                e.Valid = false;
                e.ErrorText = "User Role is Required";
            }
        ...
        private void bbiRefresh_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            bsiRecordsCount.Caption = "RECORDS : " + _users.ToList().Count;
            ...
            if (gridView1.SelectedRowsCount > 0)
            {
                ...
                if (!view.IsGroupRow(rowHandle))
                {
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        User dw = (User)view.GetRow(rowHandle);
                        dw.IsActive = false;
                         _context.SaveChanges();
